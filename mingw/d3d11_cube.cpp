...
// Variables Globales de DirectX 11
...
// Código del Shader HLSL embebido
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int nCmdShow) {
    ...
    RegisterClassW(&wc);
    HWND hWnd = CreateWindowW(L"D3D11CubeWindowClass", L"Cubo 3D - Direct3D 11 Puro con g++", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 800, 600, nullptr, nullptr, hInstance, nullptr);
    ShowWindow(hWnd, nCmdShow);

    // 2. Inicializar Device y SwapChain
    ...
    // 3. Compilar e inicializar Shaders
    ...
    // 4. Datos del Cubo (Vértices e Índices)
    Vertex vertices[] = {
    ...
    // 5. Bucle de Mensajes y Renderizado
    MSG msg = {0};
    float t = 0.0f;
    while (WM_QUIT != msg.message) {
        if (PeekMessage(&msg, nullptr, 0, 0, PM_REMOVE)) {
            ...
            // Actualizar rotación matemática
            t += 0.005f;
            ...
            // Renderizar frame
            float ClearColor[4] = { 0.1f, 0.2f, 0.4f, 1.0f }; // Fondo Azul Oscuro
